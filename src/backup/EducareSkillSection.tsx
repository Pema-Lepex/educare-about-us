...
import { EducareSkillContent } from "assets/content/about/About";
import { CommonHeader, CommonParagraph } from "components";
import { landing1, landing2, landing3, landing4, landing5, landing6, landing7, landing8, landing9, landing10 } from "./images";
...
const EducareSkillSection: React.FC = () => {
  ...
  return (
    <section id="about-educare-skill" className="px-4 sm:px-8 md:px-16 lg:px-24 py-16">
      <div className="flex flex-col lg:flex-row items-center justify-center gap-10">
        <div className="flex-1 text-center lg:text-left space-y-2">
          <CommonHeader>{EducareSkillContent.title}</CommonHeader>
          <h4 className="text-2xl sm:text-3xl md:text-4xl font-extralight italic">{EducareSkillContent.subTitle}</h4>
          <div className="space-y-4 pt-2">
            <CommonParagraph>
            {EducareSkillContent.content1}
          </CommonParagraph>
          <CommonParagraph>
            {EducareSkillContent.content2}
          </CommonParagraph>
          </div>
        </div>
