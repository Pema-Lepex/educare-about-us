...
const ImpactHeaderSection: React.FC = () => {
  ...
  <div className="relative w-full">
    ...
    />
    <div className="absolute inset-0 flex mt-7 lg:mt-0 lg:items-center justify-end px-6 sm:px-12 md:px-24 lg:px-32">
      <div className="w-2/3 md:w-3/5 lg:w-2/5 text-left">
        <p className="text-[10px] sm:text-base md:text-base lg:text-lg xl:text-2xl 2xl:text-3xl 3xl:text-4xl 4xl:text-5xl 5xl:text-6xl text-white mb-2 sm:mb-4 leading-tight px-5 lg:px-0">
        ...
        <p className="text-[10px] sm:text-base md:text-base xl:text-2xl 2xl:text-3xl 3xl:text-4xl 4xl:text-5xl 5xl:text-6xl font-bold text-yellow-400 px-5 lg:px-0">
