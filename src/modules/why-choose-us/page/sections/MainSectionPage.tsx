...
const MainSectionPage: React.FC = () => {
  ...
  return (
    <div className="bg-white ">
      ...
      <section className="px-4 pb-16  pt-[1850px] xs:pt-[1500px] sm:pt-[1380px] md:pt-[1320px] lg:pt-[850px] xl:pt-[820px] 2xl:pt-[950px] 3xl:pt-[920px] 4xl:pt-[1250px] 5xl:pt-[1400px]">
