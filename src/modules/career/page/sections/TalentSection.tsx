...
import { CommonHeader1, CommonHeader2, CommonHeader3, CommonHeader4, CommonParagraph1, CommonParagraph2 } from 'components';
    ...
    <section className="py-16 px-4 max-w-6xl mx-auto space-y-12">
      ...
      <div className="border border-purple-300 rounded-2xl p-6 md:p-10 bg-white shadow-sm">
        <CommonParagraph1 className="text-gray-700 mb-8 ">
          If you are a creative maverick with an unquenchable desire to tell a story and are comCommonHeader2etent in any of the following areas, we'd love to hear from you:
        </CommonParagraph1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {skills.map((skill, index) => (
            <div key={index} className="flex items-center gap-3 bg-purple-50 p-4 rounded-xl border border-purple-100">
              ...
              <CommonParagraph2 className="text-gray-800 font-medium">{skill}</CommonParagraph2>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="border border-customOriange-200 rounded-2xl p-6 md:p-10 bg-white shadow-sm">
        <CommonHeader4 className="font-semibold text-orange-500 mb-4">How to Apply</CommonHeader4>
      ...
      <div className="border border-customOriange-200 rounded-2xl p-6 md:p-10 bg-white shadow-sm">
        <CommonHeader4 className=" font-semibold text-orange-500 mb-6">What We Offer</CommonHeader4>
