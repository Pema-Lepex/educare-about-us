...
const DownloadOptionSection: React.FC = () => {
  return (
    <div className="w-full relative">
      ...
      />
      <section
        className="absolute top-0 left-0 flex flex-col justify-center md:justify-start  lg:pt-32 4xl:pt-60 5xl:pt-70 px-6 md:px-16 mr-16 text-black max-w-xl 4xl:max-w-5xl"
        ...
        <div className="flex flex-row gap-4">
          <a href={RedirectToAppStore.linkTo} target="_blank">
            <img
              src={AppleStoreImage}
              alt="Apple Store"
              className="h-[22px] md:h-10 lg:h-14 4xl:h-20 5xl:h-24 hover:shadow-lg hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed transition"
            />
          </a>
