...
const MainNavigation: React.FC = () => {
  ...
  return (
     <header className="fixed top-0 w-full bg-white dark:bg-bgColor-900 shadow-md dark:shadow-gray-800 z-50">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div onClick={()=> navigate('/')} className="md:text-2xl sm:text-xl text-base font-bold text-gray-800 dark:text-white cursor-pointer text-gray-800 md:hover:text-black">iBEST Technologies</div>
          <div>
